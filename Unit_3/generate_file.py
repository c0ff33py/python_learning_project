...
font_path = "NotoSerifMyanmar-Regular.ttf"
if not os.path.exists(font_path):
    raise FileNotFoundError(
        f"Font file {font_path} not found. Please download NotoSerifMyanmar-Regular.ttf and place it in the same directory as this script.")

# Initialize PDF
pdf = canvas.Canvas("employment_contract.pdf", pagesize=A4)
width, height = A4

# Register NotoSerifMyanmar font
pdfmetrics.registerFont(TTFont("NotoSerifMyanmar", font_path))

# Set initial font and position
pdf.setFont("NotoSerifMyanmar", 14)
...
# Contract details
pdf.setFont("NotoSerifMyanmar", 12)
contract_details = [
...
y_position -= 7 * mm
pdf.setFont("NotoSerifMyanmar", 10)
pdf.drawString(20 * mm, y_position,
...
# Footer (Page Number)
pdf.setFont("NotoSerifMyanmar", 8)
